...
export const fullTownData: Record<string, FullTownData> = {
  ridgewood: {
    ...
    totalArea: "5.8 sq mi",
    numZones: 14,
    character: "The Village of Ridgewood is one of Bergen County's most established suburban communities, known for its top-ranked schools, walkable downtown, and tree-lined residential neighborhoods. Ridgewood features a vibrant Central Business District along East Ridgewood Avenue with locally-owned shops and restaurants. The village's 14 zoning districts protect a strong residential character while supporting limited commercial activity. Ridgewood is also home to a NJ Transit station with direct service to NYC, and is widely regarded as a premier Bergen County community.",
    zbaSchedule: "The Ridgewood Board of Adjustment meets on the 2nd and 4th Tuesday of each month.",
    zbaTimeline: "5–8 weeks",
    zbaFee: "$300–$650",
    zones: [
      { code: "R-1", name: "Single Family Residential", description: "Low-density single-family homes", minLot: "15,000 sf", setbacks: { front: "40 ft", side: "12 ft", rear: "30 ft" }, maxHeight: "35 ft", maxCoverage: "25%", far: "0.30", variance: "c", permitted: ["Single-family detached dwellings", "Home occupations (with conditions)", "Accessory structures (sheds, garages)", "Places of worship"], conditional: ["Accessory dwelling units (ADUs)", "Home-based businesses with employees", "Bed & breakfast (max 3 rooms)"], prohibited: ["Multi-family dwellings", "Commercial uses", "Industrial uses", "Short-term rentals (<30 days)"] },
      { code: "R-2", name: "Single Family Residential", description: "Medium-density single-family homes", minLot: "10,000 sf", setbacks: { front: "35 ft", side: "10 ft", rear: "25 ft" }, maxHeight: "35 ft", maxCoverage: "30%", far: "0.35", variance: "c", permitted: ["Single-family detached dwellings", "Home occupations", "Accessory structures", "Parks and playgrounds"], conditional: ["Two-family dwellings (with variance)", "ADUs", "Day care centers"], prohibited: ["Multi-family (3+ units)", "Commercial uses", "Industrial uses"] },
      { code: "R-3", name: "Multi-Family Residential", description: "Multi-family and townhomes", minLot: "7,500 sf", setbacks: { front: "30 ft", side: "8 ft", rear: "20 ft" }, maxHeight: "40 ft", maxCoverage: "35%", far: "0.50", variance: "d", permitted: ["Multi-family dwellings", "Townhouses", "Senior housing", "Home occupations"], conditional: ["Mixed-use (ground floor commercial)", "Group homes", "Assisted living"], prohibited: ["Industrial uses", "Heavy commercial", "Auto repair/sales"] },
      { code: "C-1", name: "Central Business", description: "Downtown commercial core", minLot: "5,000 sf", setbacks: { front: "0 ft", side: "0 ft", rear: "10 ft" }, maxHeight: "45 ft", maxCoverage: "80%", far: "2.00", variance: "c", permitted: ["Retail stores", "Restaurants & cafés", "Professional offices", "Mixed-use (residential above)"], conditional: ["Drive-through facilities", "Bars/nightclubs", "Hotels"], prohibited: ["Industrial uses", "Auto repair", "Gas stations", "Warehousing"] },
      { code: "C-2", name: "General Commercial", description: "Highway commercial and services", minLot: "10,000 sf", setbacks: { front: "25 ft", side: "10 ft", rear: "20 ft" }, maxHeight: "40 ft", maxCoverage: "60%", far: "1.00", variance: "c", permitted: ["Retail stores", "Auto service stations", "Medical offices", "Banks"], conditional: ["Drive-through restaurants", "Car dealerships", "Self-storage"], prohibited: ["Heavy industrial", "Junkyards", "Adult entertainment"] },
      { code: "I-1", name: "Light Industrial", description: "Light manufacturing and warehousing", minLot: "20,000 sf", setbacks: { front: "30 ft", side: "15 ft", rear: "25 ft" }, maxHeight: "45 ft", maxCoverage: "50%", far: "0.75", variance: "d", permitted: ["Light manufacturing", "Warehousing/distribution", "Research laboratories", "Office parks"], conditional: ["Heavy manufacturing", "Waste processing", "Outdoor storage"], prohibited: ["Residential uses", "Schools", "Hospitals", "Retail (except accessory)"] },
    ],
    permits: [
      { name: "Building Permit", description: "Required for new construction, additions, and major renovations.", requirements: ["Completed application", "Two sets of construction plans", "Property survey", "Contractor license"], timeline: "3-4 weeks", fee: "$150 - $2,500", feeNote: "depending on project scope" },
      { name: "Zoning Permit", description: "Required before building permit to confirm compliance.", requirements: ["Zoning application", "Property survey", "Plot plan"], timeline: "1-2 weeks", fee: "$50 - $125", feeNote: "flat fee" },
      { name: "Demolition Permit", description: "Required for full or partial demolition.", requirements: ["Demolition plan", "Asbestos inspection", "Utility disconnect confirmation"], timeline: "2-3 weeks", fee: "$200 - $500", feeNote: "plus inspection fees" },
      { name: "Electrical Permit", description: "Required for wiring, panel upgrades, and electrical mods.", requirements: ["Licensed electrician info", "Scope of work", "Electrical plans"], timeline: "1-2 weeks", fee: "$75 - $300", feeNote: "based on amperage" },
    ],
    ordinanceCategories: ["All", "Noise", "Fencing", "Signage", "Parking", "Short-term Rentals", "Tree Removal", "Demolition"],
    ordinances: [
      { category: "Fencing", title: "Fence Height Regulations", code: "§190-122", summary: "Fences in residential zones may not exceed 6 ft in side/rear yards and 4 ft in front yards. Solid fences over 4 ft require a zoning permit.", updated: "March 2025" },
      { category: "Noise", title: "Construction Hours", code: "§145-3", summary: "Construction permitted Mon–Fri 7:30 AM to 6:00 PM, Saturday 9:00 AM to 5:00 PM. No construction on Sundays or holidays.", updated: "June 2025" },
      { category: "Short-term Rentals", title: "Short-term Rental Ordinance", code: "§190-145", summary: "Short-term rentals (less than 30 days) are prohibited in all residential zones.", updated: "August 2025" },
      { category: "Parking", title: "Residential Parking Requirements", code: "§265-15", summary: "Single-family: 2 spaces. Multi-family: 1.5 per unit plus 0.25 guest spaces.", updated: "February 2025" },
      { category: "Tree Removal", title: "Tree Preservation", code: "§260-4", summary: "Permit required for removing trees with trunk diameter of 8 inches or more. Replacement planting required.", updated: "May 2025" },
      { category: "Signage", title: "Sign Regulations", code: "§190-160", summary: "Signs in B-1 and B-2 zones require permits. Maximum area: 1.5 sq ft per linear foot of frontage.", updated: "October 2025" },
    ],
    departments: [
      { name: "Building Department", description: "Handles building permits, inspections, and code enforcement.", phone: "(201) 670-5500 ext. 218", email: "building@ridgewoodnj.net", hours: "Mon–Fri 8:30 AM – 4:30 PM", address: "131 N Maple Ave, Ridgewood, NJ 07450", website: "https://www.ridgewoodnj.net/building", portalLabel: "Online Permit Portal", portalUrl: "#" },
      { name: "Zoning Board of Adjustment", description: "Reviews variance applications and use interpretations.", phone: "(201) 670-5500 ext. 220", email: "zoning@ridgewoodnj.net", hours: "By appointment", address: "131 N Maple Ave, Ridgewood, NJ 07450", meetings: "2nd & 4th Tuesday of each month, 7:30 PM", deadlines: "Applications due 21 days before meeting", contact: "Janet Hill, Board Secretary" },
      { name: "Planning Board", description: "Reviews site plans, subdivisions, and master plan amendments.", phone: "(201) 670-5500 ext. 222", email: "planning@ridgewoodnj.net", hours: "By appointment", address: "131 N Maple Ave, Ridgewood, NJ 07450", meetings: "1st & 3rd Thursday of each month, 7:30 PM", contact: "Tom Briggs, Board Secretary" },
    ],
    upcomingMeetings: [
      { board: "Zoning Board of Adjustment", date: "April 14, 2026", time: "7:30 PM", location: "Village Hall, 131 N Maple Ave" },
      { board: "Planning Board", date: "April 16, 2026", time: "7:30 PM", location: "Village Hall, 131 N Maple Ave" },
    ],
    communityNotes: [
      { author: "Mike R.", badge: "Licensed Contractor", note: "Ridgewood building dept is responsive but strict on plan completeness. Don't submit until plans are 100% complete or you'll lose 2 weeks.", upvotes: 12, date: "Jan 2026" },
      { author: "Sarah L.", badge: "Licensed Contractor", note: "Variance applications need very detailed hardship narratives. Boilerplate gets denied.", upvotes: 9, date: "Dec 2025" },
    ],
    nearbyTowns: [
      { name: "Glen Rock", medianHome: "$635,000", zones: 6, slug: "glen-rock" },
      { name: "Paramus", medianHome: "$580,000", zones: 11, slug: "paramus" },
      { name: "Ho-Ho-Kus", medianHome: "$910,000", zones: 5 },
      { name: "Wyckoff", medianHome: "$770,000", zones: 7 },
    ],
    officialLinks: [
  ...
  paramus: {
    ...
    population: "26,698",
    medianHome: "$580,000",
    totalArea: "10.5 sq mi",
    numZones: 11,
    character: "The Borough of Paramus is one of the largest retail destinations on the East Coast, anchored by Garden State Plaza, Paramus Park, and the Bergen Town Center. Despite this commercial prominence, Paramus retains a strong residential character with 11 zoning districts that include large single-family neighborhoods. The borough is known for its strict Blue Laws prohibiting most retail on Sundays.",
    zbaSchedule: "The Paramus Board of Adjustment meets on the 1st and 3rd Thursday of each month.",
    zbaTimeline: "4–6 weeks",
    zbaFee: "$250–$500",
    zones: [
      { code: "R-1", name: "Single Family Residential", description: "Large-lot single-family homes", minLot: "12,000 sf", setbacks: { front: "30 ft", side: "10 ft", rear: "25 ft" }, maxHeight: "35 ft", maxCoverage: "30%", far: "0.35", variance: "c", permitted: ["Single-family dwellings", "Home occupations", "Accessory structures", "Houses of worship"], conditional: ["ADUs (all residential zones)", "Home-based businesses", "Group homes"], prohibited: ["Multi-family dwellings", "Commercial uses", "Industrial uses"] },
      { code: "R-2", name: "Single Family Residential", description: "Medium-lot single-family", minLot: "8,500 sf", setbacks: { front: "25 ft", side: "8 ft", rear: "20 ft" }, maxHeight: "35 ft", maxCoverage: "35%", far: "0.40", variance: "c", permitted: ["Single-family dwellings", "Home occupations", "Parks", "Accessory structures"], conditional: ["Two-family dwellings", "ADUs", "Day care"], prohibited: ["Multi-family (3+)", "Commercial", "Industrial"] },
      { code: "R-3", name: "Multi-Family Residential", description: "Townhomes and apartments", minLot: "6,000 sf", setbacks: { front: "20 ft", side: "6 ft", rear: "15 ft" }, maxHeight: "40 ft", maxCoverage: "40%", far: "0.60", variance: "d", permitted: ["Multi-family dwellings", "Townhouses", "Senior housing"], conditional: ["Mixed-use", "Assisted living", "Group homes"], prohibited: ["Industrial", "Heavy commercial", "Auto services"] },
      { code: "B-1", name: "Neighborhood Business", description: "Local retail and services", minLot: "5,000 sf", setbacks: { front: "10 ft", side: "5 ft", rear: "15 ft" }, maxHeight: "35 ft", maxCoverage: "65%", far: "1.50", variance: "c", permitted: ["Retail", "Restaurants", "Professional offices", "Banks"], conditional: ["Drive-through", "Mixed-use residential above"], prohibited: ["Industrial", "Auto repair", "Warehousing"] },
      { code: "B-2", name: "Highway Business", description: "Route 4/17 commercial corridor", minLot: "15,000 sf", setbacks: { front: "40 ft", side: "15 ft", rear: "25 ft" }, maxHeight: "45 ft", maxCoverage: "55%", far: "1.00", variance: "c", permitted: ["Shopping centers", "Auto dealerships", "Hotels", "Offices"], conditional: ["Gas stations", "Self-storage", "Entertainment venues"], prohibited: ["Residential", "Heavy industrial", "Junkyards"] },
    ],
    permits: [
      { name: "Building Permit", description: "Required for new construction, additions, and major renovations.", requirements: ["Completed application", "Two sets of construction plans", "Property survey", "Contractor license"], timeline: "3-4 weeks", fee: "$125 - $2,000", feeNote: "depending on project scope" },
      { name: "Zoning Permit", description: "Required before building permit to confirm compliance.", requirements: ["Zoning application", "Property survey", "Plot plan"], timeline: "1-2 weeks", fee: "$40 - $100", feeNote: "flat fee" },
      { name: "Demolition Permit", description: "Required for full or partial demolition.", requirements: ["Demolition plan", "Asbestos inspection", "Utility disconnect confirmation"], timeline: "2-3 weeks", fee: "$150 - $400", feeNote: "plus inspection fees" },
      { name: "Electrical Permit", description: "Required for wiring, panel upgrades, and electrical mods.", requirements: ["Licensed electrician info", "Scope of work", "Electrical plans"], timeline: "1-2 weeks", fee: "$60 - $250", feeNote: "based on amperage" },
    ],
    ordinanceCategories: ["All", "Noise", "Fencing", "Signage", "Parking", "Short-term Rentals", "Tree Removal", "Demolition", "Blue Laws"],
    ordinances: [
    ...
    departments: [
      { name: "Building Department", description: "Handles building permits, inspections, and code enforcement.", phone: "(201) 265-2100 ext. 305", email: "building@paramusborough.org", hours: "Mon–Fri 8:00 AM – 4:00 PM", address: "1 Jockish Square, Paramus, NJ 07652", website: "https://www.paramusborough.org/building", portalLabel: "Online Permit Portal", portalUrl: "#" },
      { name: "Zoning Board of Adjustment", description: "Reviews variance applications and use interpretations.", phone: "(201) 265-2100 ext. 310", email: "zoning@paramusborough.org", hours: "By appointment", address: "1 Jockish Square, Paramus, NJ 07652", meetings: "1st & 3rd Thursday of each month, 7:30 PM", deadlines: "Applications due 21 days before meeting", contact: "Maria Rodriguez, Board Secretary" },
      { name: "Planning Board", description: "Reviews site plans, subdivisions, and master plan amendments.", phone: "(201) 265-2100 ext. 312", email: "planning@paramusborough.org", hours: "By appointment", address: "1 Jockish Square, Paramus, NJ 07652", meetings: "2nd & 4th Tuesday of each month, 7:30 PM", contact: "David Park, Board Secretary" },
    ],
    upcomingMeetings: [
      { board: "Zoning Board of Adjustment", date: "April 17, 2026", time: "7:30 PM", location: "Borough Hall, 1 Jockish Square" },
      { board: "Planning Board", date: "April 28, 2026", time: "7:30 PM", location: "Borough Hall, 1 Jockish Square" },
    ],
    communityNotes: [
      { author: "Sarah K.", badge: "Licensed Contractor", note: "Paramus is strict about parking variances near retail corridors. Plan extra time for B-2 zone applications.", upvotes: 14, date: "Jan 2026" },
      { author: "Tom B.", badge: "Licensed Contractor", note: "Sunday Blue Laws still strictly enforced. Schedule deliveries Mon–Sat only for commercial work.", upvotes: 10, date: "Dec 2025" },
    ],
    nearbyTowns: [
      ...
      { name: "Maywood", medianHome: "$455,000", zones: 7 },
    ],
    officialLinks: [
