import { Search, MapPin, Hammer, Bell, FileText, Plus, ChevronRight, Clock, AlertTriangle } from "lucide-react";
...
const activeProjects = [
  { type: "Deck", address: "123 Oak St, Ridgewood", status: "Researching", icon: Hammer },
  { type: "Fence", address: "456 Maple Ave, Paramus", status: "Permit Filed", icon: Hammer },
  { type: "Pool", address: "123 Oak St, Ridgewood", status: "Planning", icon: Hammer },
];
      ...
      <div className="flex">
        ...
        <aside className="hidden lg:flex w-64 flex-col border-r bg-card min-h-[calc(100vh-3.5rem)] p-4">
          ...
          <div className="mb-6">
            ...
            <Link to="/checklist" className="flex items-center gap-2 px-2 py-2 rounded text-sm hover:bg-secondary transition-colors">
              <FileText className="h-3.5 w-3.5 text-muted-foreground" /> Permit Checklist
            </Link>
          </div>
        </aside>
        ...
        <main className="flex-1 p-6">
          <div className="max-w-4xl">
            ...
            <p className="text-sm text-muted-foreground mb-8">Here's what's happening across your saved towns.</p>
            ...
            <section>
              <h2 className="font-semibold text-sm uppercase tracking-wider text-muted-foreground mb-4">Recent Ordinance Changes</h2>
